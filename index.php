<?php
require './app/classes/DataRequest.php';

$data = new DataRequest();

$totalClients = $data->dadosClientes('c');
$totalVendors = $data->dadosFornecedores('c');
$totalUsers = $data->dadosUsuarios('c');
?>
...
<body class="page-header-fixed">
    ...
    <script src="assets/scripts/controller.js" type="text/javascript"></script>
